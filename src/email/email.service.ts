...
export const sendWelcomeEmail = async (
    ...
    try {
        ...
        const mailOptions = {
            ...
            `,
            text: `Welcome ${customerName}! Thank you for joining our car rental family! Your email has been verified and you can now log in and start exploring our vehicles. Safe travels!`
        };
